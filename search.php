	...
	<div class="container">
		...
		<div class="agile_top_brands_grids">
			...
			<div class="w3ls_w3l_banner_nav_right_grid">
				<h3>most relevant search result</h3>
<?php 
...
<!-- start category -->
	...
	$count = 0;
		...
		WHERE category LIKE '%$search%' OR description LIKE '%$search%' ";
   ...
   ?>
               ...
               <?php 
                 if ($count ==0) {
                 	echo '<h4 class="text-danger text-center">Searching result not found</h4>';
                 }
